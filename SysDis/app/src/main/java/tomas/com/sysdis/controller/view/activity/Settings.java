...
import tomas.com.sysdis.controller.network.handle_sockets.HandleServices;
...
public class Settings extends AppCompatActivity
{
    ...
    public void onClickPlus(View view)
    {
        ...
        this.message();
        this.handleServices = new HandleServices();
        this.handleServices.startIntentService(this.getApplicationContext());
    }
